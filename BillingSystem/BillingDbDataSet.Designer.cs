...
namespace BillingSystem {
    ...
    public partial class BillingDbDataSet : global::System.Data.DataSet {
        ...
        public partial class FacturasDataTable : global::System.Data.TypedTableBase<FacturasRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public FacturasRow AddFacturasRow(int IdFormaPago, int IdVendedor, int IdCliente, System.DateTime Fecha, string Comentario, int IdProducto, int Cantidad, decimal PrecioUnitario) {
        ...
        public partial class FacturasRow : global::System.Data.DataRow {
            ...
            public int IdProducto {
                get {
                    return ((int)(this[this.tableFacturas.IdProductoColumn]));
                }
                set {
                    this[this.tableFacturas.IdProductoColumn] = value;
                }
            }
...
namespace BillingSystem.BillingDbDataSetTableAdapters {
    ...
    public partial class FacturasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Facturas] WHERE (([Id] = @Original_Id) AND ([IdFormaPago] = @Original_IdFormaPago) AND ([IdVendedor] = @Original_IdVendedor) AND ([IdCliente] = @Original_IdCliente) AND ([Fecha] = @Original_Fecha) AND ([Comentario] = @Original_Comentario) AND ([IdProducto] = @Original_IdProducto) AND ([Cantidad] = @Original_Cantidad) AND ([PrecioUnitario] = @Original_PrecioUnitario))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Facturas] ([IdFormaPago], [IdVendedor], [IdCliente], [Fecha], [Comentario], [IdProducto], [Cantidad], [PrecioUnitario]) VALUES (@IdFormaPago, @IdVendedor, @IdCliente, @Fecha, @Comentario, @IdProducto, @Cantidad, @PrecioUnitario);
SELECT Id, IdFormaPago, IdVendedor, IdCliente, Fecha, Comentario, IdProducto, Cantidad, PrecioUnitario FROM Facturas WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Facturas] SET [IdFormaPago] = @IdFormaPago, [IdVendedor] = @IdVendedor, [IdCliente] = @IdCliente, [Fecha] = @Fecha, [Comentario] = @Comentario, [IdProducto] = @IdProducto, [Cantidad] = @Cantidad, [PrecioUnitario] = @PrecioUnitario WHERE (([Id] = @Original_Id) AND ([IdFormaPago] = @Original_IdFormaPago) AND ([IdVendedor] = @Original_IdVendedor) AND ([IdCliente] = @Original_IdCliente) AND ([Fecha] = @Original_Fecha) AND ([Comentario] = @Original_Comentario) AND ([IdProducto] = @Original_IdProducto) AND ([Cantidad] = @Original_Cantidad) AND ([PrecioUnitario] = @Original_PrecioUnitario));
SELECT Id, IdFormaPago, IdVendedor, IdCliente, Fecha, Comentario, IdProducto, Cantidad, PrecioUnitario FROM Facturas WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, IdFormaPago, IdVendedor, IdCliente, Fecha, Comentario, IdProducto, Can" +
                "tidad, PrecioUnitario FROM dbo.Facturas";
        ...
        public virtual int Fill(BillingDbDataSet.FacturasDataTable dataTable) {
        ...
        public virtual BillingDbDataSet.FacturasDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BillingDbDataSet.FacturasDataTable dataTable = new BillingDbDataSet.FacturasDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BillingDbDataSet.FacturasDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, int Original_IdFormaPago, int Original_IdVendedor, int Original_IdCliente, System.DateTime Original_Fecha, string Original_Comentario, int Original_IdProducto, int Original_Cantidad, decimal Original_PrecioUnitario) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_IdFormaPago));
            ...
            this.Adapter.DeleteCommand.Parameters[6].Value = ((int)(Original_IdProducto));
            this.Adapter.DeleteCommand.Parameters[7].Value = ((int)(Original_Cantidad));
            this.Adapter.DeleteCommand.Parameters[8].Value = ((decimal)(Original_PrecioUnitario));
        ...
        public virtual int Insert(int IdFormaPago, int IdVendedor, int IdCliente, System.DateTime Fecha, string Comentario, int IdProducto, int Cantidad, decimal PrecioUnitario) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(IdFormaPago));
            ...
            this.Adapter.InsertCommand.Parameters[7].Value = ((decimal)(PrecioUnitario));
        ...
        public virtual int Update(
                    ...
                    int Id) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(IdFormaPago));
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((decimal)(PrecioUnitario));
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_Id));
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_IdFormaPago));
            ...
            this.Adapter.UpdateCommand.Parameters[16].Value = ((decimal)(Original_PrecioUnitario));
        ...
        public virtual int Update(
                    ...
                    int Original_Cantidad, 
                    decimal Original_PrecioUnitario) {
            return this.Update(IdFormaPago, IdVendedor, IdCliente, Fecha, Comentario, IdProducto, Cantidad, PrecioUnitario, Original_Id, Original_IdFormaPago, Original_IdVendedor, Original_IdCliente, Original_Fecha, Original_Comentario, Original_IdProducto, Original_Cantidad, Original_PrecioUnitario, Original_Id);
        }
    }
